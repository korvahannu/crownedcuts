...
create table if not exists reservations (username varchar(50) NOT NULL, dateAndTime integer NOT NULL, barberId integer NOT NULL, primary key(barberId, dateAndTime));
