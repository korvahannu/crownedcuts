...
create table if not exists reservations(username varchar(50) NOT NULL, year integer NOT NULL, month integer NOT NULL, day integer NOT NULL, hour integer NOT NULL, barberId integer NOT NULL, primary key (barberId, year, month, day, hour));
